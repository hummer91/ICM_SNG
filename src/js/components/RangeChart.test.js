...
describe('RangeChart Component', () => {
  ...
  describe('이벤트 처리', () => {
    it('셀 클릭 이벤트를 처리해야 함', () => {
      ...
      const aaCell = Array.from(chart.querySelectorAll('.range-cell'))
        .find(cell => cell.querySelector('.range-cell-label')?.textContent === 'AA');
    ...
    it('호버 이벤트를 처리해야 함', () => {
      ...
      const kkCell = Array.from(chart.querySelectorAll('.range-cell'))
        .find(cell => cell.querySelector('.range-cell-label')?.textContent === 'KK');
  ...
  describe('레이블 및 표시', () => {
    ...
    it('음수 EV 값을 올바르게 표시해야 함', () => {
      ...
      const cell = Array.from(chart.querySelectorAll('.range-cell'))
        .find(cell => cell.querySelector('.range-cell-label')?.textContent === '72');
